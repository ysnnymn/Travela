...
using Travela.WebUI.Dtos.DestinationDto;
...
namespace Travela.WebUI.Controllers
{
    public class DestinationController : Controller
    {
        ...
        public async Task< IActionResult> DestinationList()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:7002/api/Destinations");
        ...
        
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7002/api/Destinations", stringContent);
            if (responseMessage.IsSuccessStatusCode)
            {
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync("https://localhost:7002/api/Destinations/GetDestination?id="+id);
            var jsonData = await responseMessage.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> UpdateDestination(UpdateDestinationDto updateDestinationDto)
        {
            ...
            StringContent stringContent = new StringContent(jsonData, Encoding.UTF8, "application/json");
            await client.PutAsync("https://localhost:7002/api/Destinations", stringContent);
            return RedirectToAction("DestinationList");
        }
        ...
        {
            var client = _httpClientFactory.CreateClient();
            await client.DeleteAsync("https://localhost:7002/api/Destinations?id=" + id);
            return RedirectToAction("DestinationList");
        }
